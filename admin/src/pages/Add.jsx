...
const Add = ({ token }) => {
  ...
  return (
    <>
      <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 max-w-6xl mx-auto mt-10 flex flex-col md:flex-row items-center md:items-start gap-8">
        {/* Image Section */}
        <img
          src={Image}
          alt="StitchMeUp Fashion"
          className="w-full md:w-1/2 rounded-xl object-cover shadow-md"
        />

        {/* Text Section */}
        <div className="text-center md:text-left md:w-1/2">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">StitchMeUp</h2>
